...
- (void)getNews{
    NSString *urlString = @"http://www.telize.com/geoip?";
...
//    NSManagedObject *object = [self.fetchedResultsController objectAtIndexPath:indexPath];
    cell.textLabel.text = [[currencies objectAtIndex:indexPath.row] ip];
}
...
//    for (NSDictionary *current in dictionary) {
        IpObject *ipObject = [[IpObject new] initWithDictionary:dictionary];
        [currencies addObject:ipObject];
